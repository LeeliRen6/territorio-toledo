<template>
    <header>
        <nav class="container">
            <div class="branding">
                <router-link class="header" :to="{name: 'Home'}">Controle de Territorios</router-link>
            </div>
            <div class="nav-links">
                <ul v-show="!mobile">
                    <router-link class="link" :to="{name: 'Home'}">Home</router-link>
                    <router-link class="link" :to="{name: 'Territorios'}">Territorios</router-link>
                    <router-link class="link" :to="{name: 'Controle'}">Controle</router-link>
